<?php
	//Connect to database
    $servername = "employee.ctjatm9stcxs.eu-central-1.rds.amazonaws.com";
    $username = "hradmin";		//put your phpmyadmin username.(default is "root")
    $password = "hrGUnhemFbvr4cTmrQ";			//if your phpmyadmin has a password put it here.(default is "root")
    $dbname = "";
